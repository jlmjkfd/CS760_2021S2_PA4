...
def main():
	...
	tot_topic_vectors_path =  'pnas_tot_topic_vectors.csv'
	tot_topic_mixtures_path =  'pnas_tot_topic_mixtures.csv'
	tot_topic_shapes_path =  'pnas_tot_topic_shapes.csv'
	tot_pickle_path =  'pnas_tot.pickle'
	...
	# phi is the probability of a word under a topic
	# phi's `index` + 1 = `word id`, use `word id` to find most frequently appeared words in `dictionary`
